    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/kjoivmasopkpaoksd/kotlinandroidtemplatetest1/")
                ...
                developers {
                    developer {
                        id.set("kjoivmasopkpaoksd")
                        name.set("kjoivmasopkpaoksd")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/kjoivmasopkpaoksd/kotlinandroidtemplatetest1.git")
                    developerConnection.set("scm:git:ssh://github.com/kjoivmasopkpaoksd/kotlinandroidtemplatetest1.git")
                    url.set("https://github.com/kjoivmasopkpaoksd/kotlinandroidtemplatetest1/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/kjoivmasopkpaoksd/kotlinandroidtemplatetest1/issues")
                }
            }
        }
    }
